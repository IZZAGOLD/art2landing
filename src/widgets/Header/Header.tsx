      ...
      <div className={styles.content}>
        ...
        <div className={styles.buttons}>
          <div className={styles.marketsButtons}>
            <a className={cn(styles.marketButton, styles.gp)}>
              <ExportedImage src={googlePlay} alt={'google play'} />
            </a>
            <a className={cn(styles.marketButton, styles.ap)}>
            ...
            <button onClick={() => setIsVisibleMenu((prev) => !prev)}>
              {isVisibleMenu ? <IconX /> : <IconBurgerMenu />}
            </button>
          </div>
