...
export const SectionPersonalData = () => {
  return (
    <section id={'personal-data'} className={cn(styles.wrapper, 'section')}>
      <div
        style={{
          marginTop: 0,
        }}
      ...
      >
        <h2 className={cn(styles.title, 'h1 mb-12')}>
          Collecting and Using Your Personal Data
        </h2>

        <h3 className={cn(styles.title, 'mb-24')}>Types of Data Collected</h3>

        <h3 className={cn(styles.accent, 'mb-12')}>Personal Data</h3>
        ...
        <h3 className={cn(styles.accent, 'mb-12')}>Usage Data</h3>
        ...
        <p className={'body3 mb-24'}>
          ...
          Company's servers and/or a Service
          <br />
        ...
        <h3 className={cn(styles.accent, 'mb-12')}>
        ...
        <ul className={'mb-24'}>
          <li className={'body3'}>Comply with a legal obligation</li>
          <li className={'body3'}>
          ...
          <li className={'body3'}>Protect against legal liability</li>
        </ul>
        ...
        <h3 className={cn(styles.accent, 'mb-12')}>Children's Privacy </h3>
        ...
        <h3 className={cn(styles.accent, 'mb-12')}>Links to Other Websites</h3>
        ...
        <h3 className={cn(styles.accent, 'mb-12')}>Contact Us</h3>

        <p className={'body3'}>
          If you have any questions about this Privacy Policy, You can contact
          us:
          <br />
          By email: artsqrd@gmail.com
          <br />
          <br />
          Privacy Policy for ArtSqrd
        </p>
      </div>
    </section>
  )
